...
class Libro:
    def __init__(self, data):
        ...
        #lista de autores q guardaremos como favorito el libro
        self.favorito_de_autores = []


    #mostrar libros y los vamos guardando en una lista vacia / fila es una variable
    @classmethod
    ...
    #mostrar libros q no son favoritos
    @classmethod
